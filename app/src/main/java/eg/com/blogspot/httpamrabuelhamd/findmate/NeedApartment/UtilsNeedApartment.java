 ...
 */
//todo make this class public by moving it to the main pacackg
...
//                earthquakes.add(earthquake);
    ...
    public static ArrayList<String> getGovernorates(){
    ...
    public static ArrayList<String> getSubregions(int position){
        position--;
        ArrayList<String> arrayList = new ArrayList<>();
        try {
            JSONArray regionsArray = getJsonArray();
